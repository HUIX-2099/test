...
| Index | Service | Icon |
|-------|---------|------|
| `01` | Cloud Solutions | ☁️ Cloud |
| `02` | Cyber Security | 🛡️ Shield |
| `03` | Microsoft Azure | ⚙️ Cpu |
| `04` | E-Governance | 🏛️ Building |
| `05` | IT Operations | 🖥️ Server |
| `06` | IT Consulting | ⚙️ Settings |

**Circle Design Specs:**
- **Center Node**: "AmaraTech" label in a larger circle with pulsing border animation
- **Outer Nodes**: 6 circles arranged hexagonally (60° apart), each with icon + short label
...
- **Interaction**: Click node → highlights connection + shows detail panel
