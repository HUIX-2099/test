...
const serviceCategories = [
  {
    ...
    color: '#C81E1E',
    services: [
      { name: 'Cybersecurity Strategy', desc: 'Framework development & identity management' },
      { name: 'IT Cloud Modernization', desc: 'Work from anywhere with secure access' },
      { name: 'AI Cybersecurity', desc: 'AI-based risk management solutions' },
      { name: 'AI LMS Platform', desc: 'AI-powered learning for digital skills' },
    ]
  },
  {
    id: 'data-management',
    ...
    color: '#A855F7',
    services: [
      { name: 'Artificial Intelligence', desc: 'AmaraCloud AI for business intelligence' },
      { name: 'Business Intelligence', desc: 'Transform data into strategic insights' },
    ]
  },
  {
    id: 'it-telecom',
    ...
    color: '#22C55E',
    services: [
      { name: 'Consulting Service', desc: 'Strategic IT infrastructure outsourcing' },
      { name: 'IOT Services', desc: 'Digital economy operations optimization' },
      { name: 'Capacity Building', desc: 'Technical skills & leadership development' },
    ]
  },
  {
    ...
    color: '#00D1FF',
    services: [
      { name: 'CRM Implementation', desc: 'Customer engagement & business growth' },
      { name: 'E-Governance', desc: 'Digital identity & citizen platforms' },
    ]
  },
];
...
const featuredServices = [
  ...
  {
    number: '03',
    title: 'E-GOVERNANCE & MANAGEMENT SOLUTIONS',
    icon: Briefcase,
  },
];
