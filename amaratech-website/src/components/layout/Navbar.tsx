    ...
    <>
      ...
      <header className={`${styles.navbar} ${isScrolled ? styles.scrolled : ''}`}>
        <div className={styles.navContainer}>
          ...
          {/* System Status Indicators - Always visible with inline styles */}
          <div 
          ...
          >
            ...
            >
              ...
              <span style={{ display: 'inline' }}>{osInfo.name}</span>
            </div>
            ...
            >
              <Usb size={14} style={{ color: 'rgba(255, 255, 255, 0.4)' }} />
              <span style={{ display: 'inline' }}>USB</span>
            </div>
          </div>
